...
# Integration Tests (Feature: 001-test-validation-dashboard)
pytest tests/test_integration/               # Run all integration tests
pytest tests/test_integration/test_data_pipeline.py -v  # Data pipeline tests
pytest tests/test_integration/test_signal_to_trade.py -v  # Signal-to-trade tests
pytest tests/test_integration/ --durations=10  # Show slowest tests
...
# Validation Results Storage (Feature: 001-test-validation-dashboard)
python scripts/create_validation_schema.py   # Create validation_results table
python scripts/validate_backtest_results.py --strategy GridTrading  # Run validation with DB storage
```
