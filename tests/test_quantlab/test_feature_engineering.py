...
class TestFeatureEngineer:
    ...
    @pytest.mark.skip(
        reason="Requires pandas_ta (derived features depend on technical indicators)"
    )
    def test_add_all_features_without_pandas_ta(
...
class TestFeatureEngineeringIntegration:
    ...
    def test_feature_engineer_with_target_labels(
        self, feature_engineer, sample_ohlcv_data
    ):
