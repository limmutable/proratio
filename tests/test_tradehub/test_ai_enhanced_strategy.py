...
class TestAIEnhancedStrategy:
    ...
    def test_populate_entry_trend_with_ai_long(self, strategy, sample_dataframe, mock_long_signal):
        ...
        df.loc[df.index[-1], 'volume'] = df.loc[df.index[-1], 'volume_mean'] * 1.5  # High volume
    ...
    def test_populate_entry_trend_no_ai_short(self, strategy, sample_dataframe, mock_short_signal):
    ...
    def test_populate_exit_trend_with_ai_short(self, strategy, sample_dataframe, mock_short_signal):
    ...
    def test_custom_stake_amount_high_confidence(self, strategy, mock_long_signal):
        ...
        high_confidence_signal = ConsensusSignal(
            ...
            failed_providers=[],
            provider_models={'claude': 'sonnet-4', 'gemini': 'gemini-2.0', 'chatgpt': 'gpt-5'}
        )
